 ...
 * @property {any} initialUser - The authenticated user's data.
 * @property {string} roleTitle - Display title for the UI (e.g., "Administrator Profile").
 */
interface UserProfileClientProps {
    initialUser: any;
    roleTitle?: string;
...
/**
 * Highly reusable Client Component for managing user profiles and security settings.
 * @component
 * @param {UserProfileClientProps} props
 * @returns {JSX.Element}
 */
        ...
        <div className="flex flex-col gap-8 relative">
            ...
            <div className="bg-base-100 rounded-4xl shadow-sm border border-base-content/5 overflow-hidden">
                ...
                <form onSubmit={handlePasswordSubmit} className="p-6 sm:p-8 flex flex-col gap-6">
                    ...
                    <div className="flex justify-end pt-4">
                        <button type="submit" disabled={isPasswordSubmitting} className="btn btn-outline btn-error rounded-xl px-8">
